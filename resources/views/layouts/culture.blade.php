...
<html lang="zxx">
  <head>
    ...
    <title>Mahabodhhi Channel- Culture</title>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="d-flex position-relative  float-left">
              <h3 class="section-title">Culture News</h3>
            </div>
          </div>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header p-0"><div class="position-relative image-hover">
                          <img
                            src="https://mahabodhichannel.com/worldnewsImg/a1.jpeg"
                            class=""
                            alt="world-news"
                          style="width: 100%;height: 200px;" />
                          <span class="thumb-title">culture</span>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <h5 class="font-weight-600 mt-3">
                            <p class="fs-15 font-weight-normal">Social Justice Is Now the Fourth Purpose of Public Schools and All Four Are in Conflict
                                <span id="dots">...</span>
                ...
                <div class="card">
                    <div class="card-header p-0"><div class="position-relative image-hover">
                          <img
                            src="https://mahabodhichannel.com/worldnewsImg/b3.jpg"
                            class=""
                            alt="world-news"
                          style="width: 100%;height: 200px;" />
                          <span class="thumb-title">culture</span>
